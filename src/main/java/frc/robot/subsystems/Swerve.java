...
public class Swerve extends SubsystemBase {
    ...
    public Swerve() {
        ...
        AutoBuilder.configureHolonomic(
            this::getPose, 
            (pose2d) -> {
                Swerve.this.gyro.reset();
                Swerve.this.resetOdometry(pose2d);
            },
    ...
    private void driveFromChassisSpeeds(ChassisSpeeds speed) {
    ...
    public ChassisSpeeds getChassisSpeeds() {
        ...
        for (int i = 0; i < mSwerveMods.length; i++) {
            modules[i] = mSwerveMods[i].getState();
        }

        return Constants.Swerve.swerveKinematics.toChassisSpeeds(modules);
    }
